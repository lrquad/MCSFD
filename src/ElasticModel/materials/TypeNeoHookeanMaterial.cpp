...
void TypeNeoHookeanMaterial<TYPE>::computeImaginaryP(int elementIndex, Matrix3 &F, Matrix3 &iF, Matrix3 &P, TYPE h)
{
	...
	det_F = F_complex[0] * (F_complex[4] * F_complex[8] - F_complex[5] * F_complex[7]) - F_complex[3] * (F_complex[1] * F_complex[8] - F_complex[2] * F_complex[7]) + F_complex[6] * (F_complex[1] * F_complex[5] - F_complex[2] * F_complex[4]);
