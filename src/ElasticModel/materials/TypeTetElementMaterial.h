...
protected:
	...
	std::vector<LoboComplext> element_dE_dI;
	std::vector<LoboComplexDualt> element_dE_dIdI;
	...
	std::vector<lobo::LoboComplexMatrix3<LoboComplexDualt, TYPE>> E_dualcomplex_list;
