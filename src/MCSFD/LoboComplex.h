...
{
	MCSFD_all = 1 << 0,
	MCSFD_image = 1 << 1,	 // generted mesh by tetgen
	MCSFD_real_image = 1 << 2 // generted mesh by tetgen
};
...
TemplateHead
	TYPE
	sqaure_norm(const LoboComplexType &a);

TemplateHead
	TYPE
	norm(const LoboComplexType &a);
...
TemplateHead
	LoboComplexType
	pow(const LoboComplexType &a, Scalar b);

TemplateHead double powS(const LoboComplex<double, double> &a, double b);

TemplateHead double normS(const LoboComplex<double, double> &a);

TemplateHead
	LoboComplex<double, double>
	logS(const LoboComplex<double, double> &a);
...
TemplateHead
	LoboComplexType
	cos(const LoboComplexType &a);

TemplateHead
	LoboComplexType
	sin(const LoboComplexType &a);
...
TemplateHead
	LoboComplexType
	cosh(const LoboComplexType &a);

TemplateHead
	LoboComplexType
	sinh(const LoboComplexType &a);

TemplateHead
	LoboComplexType
	tanh(const LoboComplexType &a);
...
TemplateHead
	LoboComplexType
	atan2(const LoboComplexType &b, const LoboComplexType &a);
...
TemplateHead bool largerReal(const LoboComplexType &a, const Scalar &b);

TemplateHead bool largerReal(const LoboComplexType &a, const LoboComplexType &b);
...
TemplateHead void setALLZero(LoboComplexType &a);

TemplateHead bool smallerReal(const LoboComplexType &a, const Scalar &b);

TemplateHead bool smallerReal(const LoboComplexType &a, const LoboComplexType &b);
...
TemplateHead
	LoboComplexType
	multi(const LoboComplexType &a, const LoboComplexType &b);

TemplateHead void multiScalr(const LoboComplexType &a, const Scalar &b, LoboComplexS &c);

TemplateHead void multi(const LoboComplexS &a, const LoboComplexS &b, LoboComplexS &c);

TemplateHead void multi(const LoboComplexD &a, const LoboComplexD &b, LoboComplexD &c);

TemplateHead void multi(const LoboComplexT &a, const LoboComplexT &b, LoboComplexT &c);

TemplateHead void divide(const LoboComplexS &a, const LoboComplexS &b, LoboComplexS &c);

TemplateHead void divide(const LoboComplexD &a, const LoboComplexD &b, LoboComplexD &c);

TemplateHead void divide(const LoboComplexT &a, const LoboComplexT &b, LoboComplexT &c);

TemplateHead void add(const LoboComplexType &a, const LoboComplexType &b, LoboComplexType &c);

TemplateHead void add_a(LoboComplexType &a, const LoboComplexType &b);
...
TemplateHead void powS(const LoboComplexS &a, double b, LoboComplexS &c);
TemplateHead void powS(const LoboComplexD &a, double b, LoboComplexD &c)
{
}
TemplateHead void powS(const LoboComplexT &a, double b, LoboComplexT &c)
{
}

TemplateHead class LoboComplex
{
public:
...
TemplateHead void lobo::LoboComplexType::setZero()
{
...
TemplateHead void add_a(LoboComplexType &a, const LoboComplexType &b, int flag)
{
	//a.real_ += b.real_;
	//a.image_ += b.image_;
...
TemplateHead 
inline void multi(const LoboComplexD &a, const LoboComplexD &b, LoboComplexD &c, int flag)
{
	if (flag == MCSFD_all)
	{
		c.real_.real_ = a.real_.real_ * b.real_.real_;
...
TemplateHead void powS(const LoboComplex<double, double> &a, double b, LoboComplex<double, double> &c)
{
...
TemplateHead inline bool operator==(const LoboComplexType &lhs, const Scalar &rhs)
{
...
TemplateHead inline LoboComplexType operator+(const LoboComplexType &lhs, const LoboComplexType &rhs)
{
...
TemplateHead inline LoboComplexType operator+(const LoboComplexType &lhs, const Scalar &rhs)
{
	LoboComplexType r = lhs;
	r += rhs;
	return r;
...
TemplateHead inline LoboComplexType operator+(const Scalar &lhs, const LoboComplexType &rhs)
{
	LoboComplexType r = lhs;
	return r + rhs;
}
...
TemplateHead inline LoboComplexType operator+(const LoboComplexType &x)
{
	return x;
}
...
TemplateHead
	LoboComplexType &
	lobo::LoboComplexType::operator/=(const LoboComplexType &rhs)
{
...
TemplateHead
	lobo::LoboComplexType &
	lobo::LoboComplexType::operator=(const Scalar &rhs)
{
	real_ = rhs;
	return *this;
}
...
TemplateHead
	lobo::LoboComplexType &
	lobo::LoboComplexType::operator*=(const Scalar &t)
{
	real_ *= t;
	image_ *= t;
	return *this;
...
TemplateHead
	std::ostream &
	operator<<(std::ostream &os, const LoboComplexType &__x)
{
